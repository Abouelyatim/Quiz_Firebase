...
class _QuizState extends State<Quiz> {
  ...
  void updateQuiz() async {
    ...
    isTrueCorrectAnswer = widget.questions[questionIndex].isCorrect;//correctAnswer.toLowerCase() == 'true';

    bool isPlayerCorrect = selectedAnswer == isTrueCorrectAnswer; //correctAnswer.toLowerCase();
    ...
    if (questionIndex < widget.questions.length) {
      ...
      Navigator.push(context,
        MaterialPageRoute(builder: (context) => ResultScreen(numberOfCorrectAnswers: numberOfCorrectAnswers,
